...
function problemA () {
  ...
  // promise version
  promisifiedReadFile("poem-one/stanza-01.txt").then((v) => blue(v), null);
...
function problemB () {
  ...
  // promise version
  promisifiedReadFile("poem-one/stanza-02.txt").then((v) => blue(v));
  promisifiedReadFile("poem-one/stanza-03.txt").then((v) => blue(v), null);
